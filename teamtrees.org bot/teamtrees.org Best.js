...
(async () => {
    const browser = await puppeteer.launch({
     ...
     let best = await teamtreespage.$$('a[id="top-donations-tab"]');
     await best[0].click();
 
     await teamtreespage.screenshot({path: 'tree.png',  clip: {x: 693, y: 6, width: 533, height: 394}}).then(console.log("took a pic"));
